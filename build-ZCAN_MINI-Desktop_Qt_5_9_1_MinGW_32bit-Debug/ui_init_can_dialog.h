/********************************************************************************
** Form generated from reading UI file 'init_can_dialog.ui'
**
...
#ifndef UI_INIT_CAN_DIALOG_H
#define UI_INIT_CAN_DIALOG_H
...
public:
    ...
    void setupUi(QDialog *InitCanDialog)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 259, 450));
    ...
    {
        InitCanDialog->setWindowTitle(QApplication::translate("InitCanDialog", "Dialog", Q_NULLPTR));
