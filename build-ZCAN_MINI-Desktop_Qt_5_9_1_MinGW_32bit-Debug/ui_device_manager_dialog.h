/********************************************************************************
** Form generated from reading UI file 'device_manager_dialog.ui'
**
...
public:
    ...
    void setupUi(QDialog *DeviceManagerDialog)
    {
        ...
        DeviceManagerDialog->resize(236, 161);
    ...
    {
        DeviceManagerDialog->setWindowTitle(QApplication::translate("DeviceManagerDialog", "Dialog", Q_NULLPTR));
